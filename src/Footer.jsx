...
export default function Footer() {
  return (
    <div className="   flex-col bg-linear-to-b from-[#18000000] to-[#180000] backdrop-blur-[0px] text-white py-4  text-center text-lg lg:text-sm flex  justify-around items-center z-250">
      <h4 className="py-5">
        Per saber preus, disponibilitat de productes, assessorament, etc...
        CONTACTA amb nosaltres!
      </h4>
      <div className="flex w-full flex-col lg:flex-row justify-around items-center gap-10">
        <div className=" flex-col justify-center gap-10 items-center ">
        ...
        <div className="flex gap-6">
          <a
            href="https://www.facebook.com/MonicaMobles/?locale=es_ES"
            target="_blank"
            rel="noopener"
          ...
          <a
            href="https://www.instagram.com/monicamobles_somnis_descans/"
            target="_blank"
            rel="noopener"
