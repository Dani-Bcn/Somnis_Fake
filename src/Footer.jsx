...
export default function Footer() {
  return (
    <div className="   flex-col bg-linear-to-b from-[#18000000] to-[#180000] backdrop-blur-[0px] text-white py-4  text-center  lg:text-sm flex  justify-around items-center z-250">
      <h4 className="py-5">
