...
export default function Podium_plus() {
  ...
  const images = [
    {
      id: 1,
      src: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=768,h=768,fit=crop/YBgjMgabRgiQr27z/podium_pus_sin-U8mdfePUmyDpD6nB.webp",
      alt: "aniversari1",
    },
    {
      id: 2,
      src: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=768,h=768,fit=crop/YBgjMgabRgiQr27z/75-aniversari_composicio-YNqMagzrgzIpeqEq.webp",
      alt: "aniversari2",
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h3>3 / Mod.</h3>
          <span className="text-[200px]">PODIUM PLUS</span>
        </m.div>
        ...
        <div className="flex justify-around items-center w-full gap-20 mt-20">
          <div className="text-[#ffffff]  text-start gap-4 flex flex-col">
            ...
            <p>
              2. <span>Viscofoam®</span> <br /> Capa d'encoixinat que acull la
              persona en funció de la pressió i la seva petjada tèrmica,
              adaptant-se a la forma corporal. A més, redueix la pressió
              sanguínia i dispersa la calor que generem en dormir.
            </p>
            <p>
              3. <span>Capa de fibra de polièster</span> <br /> genera una càmera d'aire per controlar la temperatura en dormir.
            </p>
            <p>
            ...
            <p>
              5. <span>Nucli Adapt-Tech®</span> <br />
              Molles ensacats que s'adapten punt per punt a la morfologia de cada
              dorment i afavoreix la independència de llits.
            </p>
            <p>
