...
export default function Somnis() {
  ...
  const images = [
    {
      id: 1,
      src: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=768,h=768,fit=crop/YBgjMgabRgiQr27z/01_somnis-nbf0mk2wzWvSA2Wi.jpg",
      alt: "Somnis1",
    },
    {
      id: 2,
      src: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=768,h=513,fit=crop/YBgjMgabRgiQr27z/somnis-PEqwu20Xa42aZ4hi.jpg",
      alt: "Somnis2",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <AnimatePresence>
        {hoveredImage && (
          <m.div
            ...
            className="fixed inset-0 bg-[#ffffff] bg-opacity-90 z-50 flex items-center justify-center"
          ...
          >
            ...
            >
              <m.img
                ...
                className="max-w-[90vw] max-h-[70vh] object-cover brightness-93 rounded-3xl shadow-2xl cursor-pointer"
                onClick={handleCloseImage}
      ...
      >
        ...
        >
          <h3>Núm. 1 / Mod.</h3>
          <span className="text-[200px]">SOMNIS</span>
        </m.div>
        ...
        <div className="flex justify-around items-center w-full gap-20 mt-20">
          ...
          <m.div
            className="w-10/12 rounded-3xl h-82 overflow-hidden flex justify-center items-center mt-20 cursor-pointer group"
            whileHover={{ scale: 1.05 }}
            transition={{ duration: 0.3 }}
