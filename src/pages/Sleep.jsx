...
export default function Sleep() {
  ...
  const images = [
    {
      id: 1,
      src: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=768,h=768,fit=crop/YBgjMgabRgiQr27z/sleep-5UA0g7FjBaB5NDil.webp",
      alt: "aniversari1",
    },
    {
      id: 2,
      src: "https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=768,h=773,fit=crop/YBgjMgabRgiQr27z/esquema_sleep-baja-C4z7A0KMlhLuPg3U.jpg",
      alt: "aniversari2",
    },
  ];
      ...
      >
        ...
        <div className="flex justify-around items-center w-full gap-20 mt-20">
          <div className="text-[#ffffff]  text-start gap-4 flex flex-col">
            ...
            <p>
              2. <span>Progression Fiber Plus®</span> <br /> Combinació de tres
              capes (dues capes de HR Supersoft i una de fibra de polièster).
              Produeix un contacte dolç i suau al dormir ia més aquesta
              tecnologia és termoreguladora, cosa que facilita un descans de més
              qualitat.
            </p>
            <p>
              3. <span>Polièter reforçat d'alta densitat</span> <br /> Amortidor
              que proporciona una estabilitat confortable durant el descans.
            </p>
            <p>
              4. <span>Nucli Adat-Tech®</span> <br />
              Molles ensacats que s'adapten punt per punt a la morfologia de
              cada dorment i afavoreix la independència de llits.
            </p>
            <p>
              5. <span>Cinc nanses brodades</span>
              <br /> Que faciliten la mobilitat i transport del matalàs.
            </p>
            <p>
