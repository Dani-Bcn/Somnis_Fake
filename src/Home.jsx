  ...
  return (
    ...
    >
      <video
        ...
        loop
        playsInline
        className="fixed z-0 max-h-screen  scale-500 lg:scale-100 lg:top-10 brightness-50  top-35  "
      />
      <div
        ref={titleRef}
      ...
      >
        ...
        >
          <h2
            ref={titleRef}
            className="lg:text-8xl sm:-mt-10 mt-5 lg:mt-0 text-5xl bebas z-50"
          >
        ...
        {!isMobile ? (
          <section className="w-10/12 px-5 h-screen  bebas z-50">
            <div
              ...
              className="relative mt-20 w-full h-50 overflow-visible rounded-xl flex justify-center items-center  shadow-[0_0_10px_0px_rgba(184,28,28,0.5)] bg-[#50010185] p-4 my-4"
            >
